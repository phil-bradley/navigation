...
Bouyage marks such as lateral marks, cardinal marks etc. are not usually printed in colour on navigation charts, instead the colour is indicated as an abbreviation as per the list below:
